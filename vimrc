...
nnoremap ,df :tab split<CR>:YcmCompleter GoToDefinition<CR>
" Looks up the symbol under the cursor and jumps to its declaration.
nnoremap ,dc :tab split<CR>:YcmCompleter GoToDeclaration<CR>
" Looks up the current line for a header and jumps to it.
nnoremap ,di :tab split<CR>:YcmCompleter GoToInclude<CR>
...
nnoremap ,rf :tab split<CR>:YcmCompleter GoToReferences<CR>
...
let g:neocomplcache_temporary_dir = "$HOME/.vim/dirs/neocomplcache"
